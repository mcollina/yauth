...
It is interally developed as a https://github.com/hassox/warden strategy, the same library on which the popular Devise is based. 

Yauth resolve one well defined problem: protecting a web application that is going to be accessed by a few users.
